  ...
  <body>
    ...
    <div class="testbox">
      ...
      <form name="joinfrm" id="joinfrm">
        ...
        <input type="text" placeholder="번지수" name="zipcode" id="zipcode" /><button
          class="address"onclick="sample6_execDaumPostcode()" value="우편번호 찾기"
        >
          새주소 검색하기
        </button>
        <br />
        ...
        <button type="button" class="button" id="joinbtn" name="joinbtn">Register</button>
      </form>
    </div>
